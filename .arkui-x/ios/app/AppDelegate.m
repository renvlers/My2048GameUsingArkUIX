...
- (void)setNavRootVC:(id)viewController {
    ...
    UIView *statusBarPlaceholder = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIApplication sharedApplication].statusBarFrame.size.height)];
    statusBarPlaceholder.backgroundColor = [UIColor colorWithRed:(236/255.0) green:(236/255.0) blue:(236/255.0) alpha:1.0];
    [self.window addSubview:statusBarPlaceholder];
    
    UINavigationController *navi = [[UINavigationController alloc]initWithRootViewController:viewController];
    [self setNaviAppearance:navi];
    self.window.rootViewController = navi;
    
    CGRect frame = CGRectMake(0, [UIApplication sharedApplication].statusBarFrame.size.height, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - [UIApplication sharedApplication].statusBarFrame.size.height);
...
- (void)setNaviAppearance:(UINavigationController *)navi {
    if (@available(iOS 13.0, *)) {
        ...
        appearance.backgroundColor = [UIColor colorWithRed:(236/255.0) green:(236/255.0) blue:(236/255.0) alpha:1.0];
